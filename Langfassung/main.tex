...
structure Nucleus (X : Type*) [SemilatticeInf X] where
  ...
  exact left_eq_inf.mp h2
    ...
    Das Naheliegenste Ziel ist es, die Resultate von Leroy vollständig in Lean zu formalisieren und anschließend, gemeinsam mit den Grundlagen der Theorie der Lokalen in die Mathlib zu übertragen.
