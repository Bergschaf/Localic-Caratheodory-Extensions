...
% \includegraphics[scale=0.36]{OIP.jpg}
    ...
    \begin{lemma}
        ...
        \begin{itemize}
            ...
            \item $f^* f_*=1_{O(E)}$
        \end{itemize}
        \leanok{f_injective_one} Man nennt einen Morphismus von Lokalen, der diese Eigenschaften erfüllt, Einbettung.
    \end{lemma}
    ...
    \begin{definition}
        ...
        $$(\bigcup_s S)(a) = \bigcup \{w \in E | \forall x \in S,w \subseteq x\} \text{~~für alle $a \in E$}$$
    \end{definition}
