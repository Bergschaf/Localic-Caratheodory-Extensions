...
lemma Nucleus.monotone (n : Nucleus X) : Monotone n := by
  ...
  exact left_eq_inf.mp h2
    ...
    \section{Ausblick und kritische Betrachtung der Ergebnisse}
    Das Naheliegenste Ziel ist es, die Resultate von Leroy vollständig in Lean zu formalisieren und anschließend, gemeinsam mit den Grundlagen der Theorie der Lokale in die Mathlib zu übertragen.
