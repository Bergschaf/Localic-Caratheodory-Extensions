...
\begin{proposition}[Sublocals structure]
    ...
    \uses{def:sublocal_intersection,def:complement,lem:union_of_intersections}
...
(Leroy Lemm 3.4)
    ...
    \uses{def:complement,def:sublocal_intersection,lem:property_1}
