...
(Stimmt das?)(Leroy Ch 3)
    \label{def:sublocal_inclusion, def:nucleus_partial_order}
    \uses{def:sublocal}
    \lean{Nucleus_le}
    \leanok
...
\begin{proof}
    ...
    TODO Quelle \link{https://proofwiki.org/wiki/Infimum_is_Unique} \\
...
\begin{lemma}[Nucleus Frame]
    ...
    \uses{lem:nucleus_complete_lattice}
