...
\begin{lemma}[Nucleus Complete Lattice]
    ...
    \uses{def:sublocal_intersection,lem:nucleus_intersection}
...
\begin{lemma}[Nucleus Distributive Lattice]
    \label{lem:nucleus_distributive_lattice}
    \uses{lem:nucleus_complete_lattice, sublocal_union_nucleus_intersection}
    \leanok
    The Nuclei form a distributive lattice.
\end{lemma}

\begin{lemma}[Nucleus Heyting Algebra]
    \label{lem:nucleus_heyting_algebra}
    \uses{lem:nucleus_distributive_lattice}
    \leanok
